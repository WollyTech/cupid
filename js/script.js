...
function reply(response) {
    if (response === 'Yes') {
        ...
        if (noButtonClickCount === 3 && !messageDisplayed) {
            ...
            document.getElementById('retryMessage').textContent = "Mel, I know you're sick, have an exam the day AND have a marketing report due but I am too far in to stop now...";
            messageDisplayed = true;
